...
class BowlingData:
    def __init__(self, match_id, player_name_bowler, player_link_bowler, overs, maidens, runs_bowler, wickets, econ, dot_balls, _4s_bowler, _6s_bowler, wides, no_balls, country):
    ...
    def saveRecord(self):
        with open('./CricMatchBowlingData.csv', 'a', newline='', encoding='utf-8') as outfile:
            ...
            csvWriter.writerow(
                [self.match_id, self.player_name_bowler, self.country, self.player_link_bowler, self.overs, self.maidens, self.runs_bowler, self.wickets, self.econ,
